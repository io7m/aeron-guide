...
public final class ExampleMDC2
{
  private static final Logger LOG =
    LoggerFactory.getLogger(ExampleMDC2.class);
    ...
    throws Exception
  {
    ...
    while (true) {
      ...
      readMessages(client_sub);
      readMessages(server_sub);
    ...
    throws InterruptedException
  {
    if (sub.isConnected()) {
      for (int index = 0; index < 10; ++index) {
        sub.poll(ExampleMDC2::onMessage, 10);
        Thread.sleep(100L);
      }
    }
  }
